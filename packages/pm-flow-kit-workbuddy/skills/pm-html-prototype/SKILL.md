...
description: Generate offline HTML product prototypes with local assets, device frames, design-token usage, font constraints, component-library mapping, and self-checks. Use when you need to create inspectable HTML prototypes from PRDs, scenario catalogs, design guidelines, or product requirements.
---
