...
description: Define product success metrics before PRD, prototype, or review output. Use when you need to convert product goals into business metrics, user behavior metrics, guardrail metrics, baselines, metric definitions, data sources, decision thresholds, non-applicability reasons, and measurement risks for requirement analysis and PRD work.
---
