---
name: pm-review
description: Perform independent product artifact reviews for pm-flow-kit. Use when you need to review requirement analysis, metrics, boundary, PRDs, prototypes, diagrams, risks, decisions, or delivery readiness and produce review.md with findings, evidence, severity, resolution status, and final readiness.
---
