---
name: humanizer
description: Polish product writing without changing facts, scope, metrics, requirements, decisions, acceptance criteria, or source meaning. Use when Codex needs to remove AI-like writing patterns from stable PRDs, requirement summaries, review notes, release notes, or product documents after product facts are already confirmed.
---
