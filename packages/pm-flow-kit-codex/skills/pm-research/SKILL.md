---
name: pm-research
description: Produce research-stage product context for pm-flow-kit. Use when Codex needs to complete opportunity, user, market, competitor, benchmark, metric context, source-risk, assumption, and open-question research before boundary, prototype, or PRD work.
---
