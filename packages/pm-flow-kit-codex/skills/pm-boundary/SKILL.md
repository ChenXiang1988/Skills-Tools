---
name: pm-boundary
description: Define boundary-stage product scope for pm-flow-kit. Use when Codex needs to create boundary.md with scope, non-scope, stakeholders, roles, permissions, client surfaces, system ownership, constraints, dependencies, assumptions, risks, priorities, and decision handoff before prototype or PRD work.
---
