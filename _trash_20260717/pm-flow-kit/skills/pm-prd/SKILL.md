---
name: pm-prd
description: Create right-sized product requirements documents. Use when you
  need to write, review, resize, or refactor PRDs using L1/L2/L3 depth,
  requirement-analysis inputs, metrics definitions, scenario catalogs, use
  cases, artifact plans, field dictionaries, acceptance criteria, and standalone
  diagram references.
disable: true
---
