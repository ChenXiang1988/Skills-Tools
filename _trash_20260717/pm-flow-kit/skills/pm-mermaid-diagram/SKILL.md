...
description: Generate standalone Mermaid diagrams for product management work.
  Use when you need to turn requirement analysis, scenario catalogs, use cases,
  PRDs, or product flows into flowcharts, swimlane-style flows, state diagrams,
  sequence diagrams, architecture diagrams, mind maps, or standalone `.mmd`
  diagram files with artifact routing and bad-output checks.
disable: true
---
