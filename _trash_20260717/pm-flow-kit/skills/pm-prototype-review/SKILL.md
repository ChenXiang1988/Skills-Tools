...
description: Create prototype review artifacts that connect UI elements to
  requirement rules. Use when requirement analysis says a separate review
  artifact is needed for comparing prototype screens, rules, fields, acceptance
  criteria, open questions, and review findings.
disable: true
---
